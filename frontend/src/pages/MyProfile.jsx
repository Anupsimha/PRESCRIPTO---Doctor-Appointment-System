...
const MyProfile = () => {
  ...
  const [userData , setUserData] = useState({
    ...
    address : {
      ...
      line2 : "Cicrlce, Church Road, London"
    },
    gender: 'Male',
    dob: '2000-01-20'
  })
          ...
          <p>Address : </p>
          {
            isEdit ? 
              <p>
                ...
                <br />
                <input onChange={(e) => setUserData(prev => ({ ...prev , address : { ...prev.address , line2 : e.target.value } }))}  value={userData.address.line2} type='text'></input>
              </p>
              : <p>
