...
const DoctorContextProvider = (props) => {
    ...
    const completeAppointment = async (appointmentId) => {
        try {
            ...
            const {data} = await axios.post(backendUrl + '/api/doctors/complete-appointment' , {appointmentId} , {
                headers : {
                    dToken
                }
            })
    ...
    const cancelAppointment = async (appointmentId) => {
        try {
            ...
            const {data} = await axios.post(backendUrl + '/api/doctors/cancel-appointment' , {appointmentId} , {
                headers : {
                    dToken
                }
            })
